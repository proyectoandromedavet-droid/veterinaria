  ...
  try {
    ...
    await db.query(
      `INSERT INTO patient_grooming_profile
       ...
       ON DUPLICATE KEY UPDATE preferred_grooming_style=VALUES(preferred_grooming_style), behavior_with_grooming=VALUES(behavior_with_grooming), muzzle_required=VALUES(muzzle_required), updated_at=NOW()`,
      {
